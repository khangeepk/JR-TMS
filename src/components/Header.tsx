...
export default function Header() {
    ...
    return (
        <header className="flex items-center justify-between h-20 px-4 md:px-8 bg-[#F1F5F9] border-b border-neutral-200/50 md:border-none">
            ...
            <div className="flex items-center gap-2 md:gap-4">
                {/* Search Bar - hidden on very small screens, shown as icon or simplified */}
                ...
                {/* Mobile Search Icon (optional, for < sm) */}
                ...
                <div className="flex items-center gap-1 md:gap-2 bg-white p-1 rounded-full shadow-sm border border-neutral-100">
                    ...
                    <div className="hidden xs:flex pr-2 items-center">
                        <LogoutButton />
                    </div>
                </div>
            </div>
